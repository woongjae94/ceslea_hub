...
class CAM:
    def __init__(self):
        ...
        parser.add_argument('--fps', type=int, default=20)  # 6, 15(1920~424), 30(1280~320), 60
        ...
        self.cam_address = 'http://192.168.0.22:3009/?action=stream'
    ...
    def get_frames(self, num, fps, cam=0):
        ...
        while True:
            ...
            if not _:
                try:
                    self.cap.release()
                    print("Lost Contact ----- Trying to reconnect...")
                    self.cap = cv2.VideoCapture(self.cam_address)
